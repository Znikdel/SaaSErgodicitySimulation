...
#ifndef __ErgodicityTest_midClient_H_
#define __ErgodicityTest_midClient_H_
 ...
 */
class INET_API midClient : public TcpAppBase
...
#endif // ifndef ___ErgodicityTest_midClient_H_
