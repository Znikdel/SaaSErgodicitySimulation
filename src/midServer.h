...
#ifndef __ErgodicityTest_midServer_H_
#define __ErgodicityTest_midServer_H_
 ...
 */
class INET_API midServer : public cSimpleModule, public LifecycleUnsupported
{
...
#endif // ifndef _ErgodicityTest_midServer_H_
